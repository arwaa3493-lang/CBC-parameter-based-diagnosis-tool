...
diagnoseButton.addEventListener("click", function () {
 ...
 if (hb < ranges.hb.low && rbc < ranges.rbc.low && rdw > ranges.rdw.high && wbc > ranges.wbc.high) {
 ...
 if (hb > ranges.hb.high && rbc > ranges.rbc.high) {
 ...
 if (mch > ranges.mch.high && mchc > ranges.mchc.high) {
 ...
 if (mchc < ranges.mch.low && mchc < ranges.mchc.low) {
